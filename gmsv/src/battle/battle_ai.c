...
#define B_AI_NORMAL_ATTACKOPTION "at" /* 撃オプション  (攻击选项) */
#define B_AI_NORMAL_GUARDOPTION "gu"  /* 御オプション  (防御选项) */
#define B_AI_NORMAL_MAGICOPTION "ma"  /* 魔法オプション  (魔法选项) */
#define B_AI_NORMAL_ESCAPEOPTION "es" /* 逃げるオプション  (逃跑选项) */
#define B_AI_NORMAL_WAZAOPTION "wa"	  /* オプション  (技能选项) */
...
static int BATTLE_ai_normal(int turn, int charaindex,
							BATTLE_ENTRY *pEntry,
							struct B_AI_RESULT *result) {
	int at[B_AI_NORMAL_ATTACKSUBOPTIONNUM] = {0, 0, 0};			  /* 撃オプション  (攻击选项) */
	int gu[B_AI_NORMAL_GUARDSUBOPTIONNUM] = {0};				  /* オプション  (防御选项) */
	int ma[B_AI_NORMAL_MAGICSUBOPTIONNUM] = {0};				  /* オプション  (魔法选项) */
	int es[B_AI_NORMAL_ESCAPESUBOPTIONNUM] = {0};				  /* オプション  (逃跑选项) */
	int wa[B_AI_NORMAL_WAZASUBOPTIONNUM] = {0, 0, 0, 0, 0, 0, 0}; /* オプション  (技能选项) */
#ifdef _ENEMY_ATTACK_AI
