...
MapTrade TRADE_DATAS[MAXTRADES] = {
	{-1, 5, 5, 0, -1, "NULL"}, {-1, 10, 5, 0, -1, "NULL"}, {-1, 5, 10, 0, -1, "NULL"}, {-1, 10, 10, 0, -1, "NULL"}};
...
BOOL MAP_TRADEDROP(int charindex, int itemindex, int floor, int x, int y) { // return FALSE 物品丢在地上 TRUE 不丢在地上(可能是贩卖道具)
	int exhibition = -1;
...
void MAPTRADE_CLEANGOLD(int floor, int num) { // TRADE_DATAS
	OBJECT object;
	int x, y;
