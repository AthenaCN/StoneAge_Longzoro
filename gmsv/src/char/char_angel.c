...
void Use_AngelToken(int charaindex, int toindex, int haveitemindex) {
	...
	if (strcmp(ITEM_getChar(itemindex, ITEM_ANGELINFO), missiontable[mindex].angelinfo) || strcmp(ITEM_getChar(itemindex, ITEM_HEROINFO), missiontable[mindex].heroinfo)) {
